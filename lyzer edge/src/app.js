...
import { LiveTradingView } from './components/LiveTradingView.js';
import { ZSpaceDashboard } from './components/ZSpaceDashboard.js';
import { RiskAnalysisView } from './components/RiskAnalysisView.js';
import { PatternRecognitionView } from './components/PatternRecognitionView.js';
...
const NAV_ITEMS = [
  ...
  { label: '🏛 Architecture & Audit', icon: 'shield', path: '#/observability', badge: 'AUDIT' },
  ...
  { label: 'Risk Analysis',  icon: 'shield',    path: '#/risk',        badge: null },
  { label: 'Patterns',       icon: 'grid',      path: '#/patterns',    badge: null },
  ...
  'divider',
  { label: 'Reports',        icon: 'reports',   path: '#/reports',     badge: null },
  { label: 'Alerts',         icon: 'alerts',    path: '#/alerts',      badge: null },
...
const ROUTES = [
  ...
  { path: '/risk',         component: () => new RiskAnalysisView(),              title: 'Risk Analysis' },
  { path: '/patterns',     component: () => new PatternRecognitionView(),        title: 'Patterns' },
  ...
  { path: '/live-trading', component: () => { const v = new LiveTradingView(); return { mount(c) { v.render(c); }, unmount() { v.destroy(); } }; }, title: 'Trading Ao Vivo' },
  { path: '/z-space-live', component: () => new ZSpaceDashboard(), title: 'Z-Space Live' },
  { path: '/reports',      component: () => new ReportsView(),                   title: 'Reports' },
  { path: '/alerts',       component: () => new AlertsView(),                    title: 'Alerts' },
