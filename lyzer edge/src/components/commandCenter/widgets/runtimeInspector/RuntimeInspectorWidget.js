...
export class RuntimeInspectorWidget {
  ...
  _render() {
    this._container.innerHTML = `
      <div style="padding: 12px; font-family: monospace; font-size: 11px; background: rgba(8,12,20,0.5); backdrop-filter: blur(16px); -webkit-backdrop-filter: blur(16px); color: #abb2bf; border: 1px solid rgba(56,189,248,0.06); border-radius: 8px; height: 100%; box-sizing: border-box; overflow-y: auto;">
