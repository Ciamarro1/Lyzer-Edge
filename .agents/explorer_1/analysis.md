# 🔍 Milestone M1: Dead Code & Orphan Mapping Analysis Report
...
| :--- | :---: | :---: | :---: | :--- |
| **Active Core** | 552 | 51 378 | 53.4% | Retain, protect, enforce 3-process isolation |
| **Ambiguous / Needs Verification** | 148 | 13 088 | 14.3% | Review for deprecation or test harness integration |
| **Definitely Dead / Orphaned** | 333 | 31 648 | 32.3% | Safe candidates for removal / archiving (YAGNI) |
| **TOTAL** | **1,033** | **96 114** | **100.0%** | **Cleanup potential: ~32.3% file reduction** |
...
- `lyzer edge/backend/streamEngine.js` — Orchestrates data ingestion $ightarrow$ V1-V4 providers $ightarrow$ TruthKernel $ightarrow$ ECA Court $ightarrow$ Order Execution
