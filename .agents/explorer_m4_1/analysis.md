# Milestone 4 Deduplication Investigation Report
...
- **Total Import Statements Analyzing / Targeting Duplicated Files**: **202**
...
|---|----------------|---------------------------|-------------------------------------------------------------|--------|
| 1 | `d647a7b1187ef5016eaaba5854baad3ca7c4ce33848d1b06d0606af429f99d74` | `lyzer edge/src/cer/EDLWriter.ts` | `packages/lyzer-constitution/src/cer/EDLWriter.ts` | Duplicate |
| 2 | `228e60db66a75dc97cf27b8f005b357aaeeea4152df5c3c1eae322873c105502` | `lyzer edge/src/cer/FMCObservabilityLayer.ts` | `packages/lyzer-constitution/src/cer/FMCObservabilityLayer.ts` | Duplicate |
| 3 | `c360389c77216f5e56f4769e60a485d4e0ed2062db236f375ee353130f8cec25` | `lyzer edge/src/cer/RollupEngine.ts` | `packages/lyzer-constitution/src/cer/RollupEngine.ts` | Duplicate |
| 4 | `13e027fa09765a7b81dafda2ba7529bbe00a7d7e51770387fe3cf54c05ca5893` | `lyzer edge/src/cer/SchemaCompatibilityGate.ts` | `packages/lyzer-constitution/src/cer/SchemaCompatibilityGate.ts` | Duplicate |
| 5 | `06dadaf2d8b07ac7df22927008071ddb2fc0c4cd9bd04b45b6fdd978f6774493` | `lyzer edge/src/cer/SQLiteSchema.ts` | `packages/lyzer-constitution/src/cer/SQLiteSchema.ts` | Duplicate |
| 6 | `27adf29a6f8366193e842834b0e853686d4199d8fa6b7246af824299dd14dcb1` | `lyzer edge/src/cer/types.ts` | `packages/lyzer-constitution/src/cer/types.ts` | Duplicate |
| 7 | `7bd05fbe9a54acd8241a3fe3d005bfa35eb5151290d2fa6d34566088910cd18e` | `lyzer edge/src/sil/evolutionRegistry.js` | `packages/lyzer-constitution/src/sil/evolutionRegistry.js` | Duplicate |
| 8 | `1ab26d765d48d148156bc20e6f213a40916a6a06d76fa176fb08dca1b2b17b72` | `lyzer edge/src/sil/goalMutation.js` | `packages/lyzer-constitution/src/sil/goalMutation.js` | Duplicate |
| 9 | `8b50be299262738c07629ef3a930e5dbf3499d6def75abc8a4cf79388f397147` | `lyzer edge/src/sil/meaningAuditor.js` | `packages/lyzer-constitution/src/sil/meaningAuditor.js` | Duplicate |
| 10 | `94dc887a2ead72bc47f9d940f308b9d24f39fcf4ff25811ebedacfc9f74498ac` | `lyzer edge/src/sil/ontologyDrift.js` | `packages/lyzer-constitution/src/sil/ontologyDrift.js` | Duplicate |
| 11 | `466e1f6ad2b656d4021aa71cbbfeccc63bf60458b25d132d7b8583764613333d` | `lyzer edge/src/sil/semanticInterpreter.js` | `packages/lyzer-constitution/src/sil/semanticInterpreter.js` | Duplicate |
