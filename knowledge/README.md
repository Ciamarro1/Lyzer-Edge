...
- [ADR-018: Adaptive Evaluation Architecture (Fase 7.2)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-018-adaptive-evaluation-architecture.md) — Avaliação multidimensional de impacto e custo sistêmico de adaptações.
- [ADR-019: Evolution Ledger Model (Fase 7.2)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-019-evolution-ledger-model.md) — Registro imutável da história genética do sistema.
- [ADR-020: Regime Stability Governance (Fase 7.2)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-020-regime-stability-governance.md) — Governança de estabilidade multi-regime e Regime Stability Score (RSS).
- [ADR-021: Adaptive Evolution Runtime (Fase 7.3)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-021-adaptive-evolution-runtime.md) — Runtime operacional para promoção, monitoramento e reversão de adaptações.
- [ADR-022: Parameter Version Governance (Fase 7.3)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-022-parameter-version-governance.md) — Versionamento cognitivo com snapshots, diff e lineage.
- [ADR-023: Evolution Rollback Constitution (Fase 7.3)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-023-evolution-rollback-constitution.md) — Constituição de rollback com 5 triggers multidimensionais e quarentena.
- [ADR-024: Cognitive Evolution Certification (Fase 7.4)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-024-cognitive-evolution-certification.md) — Framework de certificação de integridade evolutiva, EHS e Replay Engine.
- [ADR-025: Cognitive Market Intelligence (Fase 8)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-025-cognitive-market-intelligence.md) — Descoberta autônoma de regimes, features, hipóteses e candidatos a estratégia.
- [ADR-026: Empirical Validation Architecture (Fase 9)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-026-empirical-validation-architecture.md) — Validação estatística empírica, Causal Evidence Score (CES), WFV e maturidade de conhecimento.
- [ADR-027: Cognitive Portfolio Intelligence (Fase 10)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-027-cognitive-portfolio-intelligence.md) — Gestão cognitiva de capital, genoma de estratégias, matriz de correlação e Cognitive Allocation Score (CAS).
- [ADR-028: Cognitive Market Organism (Fase 11)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-028-cognitive-market-organism.md) — Organismo adaptativo de mercado, ecologia, competição de genomas, Alpha Decay e Market Adaptation Score (MAS).
- [ADR-029: Cognitive Operations Architecture (Fase 12)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-029-cognitive-operations-architecture.md) — Operações cognitivas, telemetria unificada (GCHI + 6 Scores), tracing de pipeline e profiling de latência/memória.
- [ADR-030: Distributed Runtime & Cognitive Kernel (Fase 13)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-030-distributed-runtime-kernel.md) — Maestro global (CognitiveKernel), Event Bus desacoplado, DI Container e Worker Pool distribuído.
- [ADR-031: Institutional Production & Knowledge Graph (Fase 14)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-031-institutional-production-knowledge-graph.md) — Abstração de corretoras (Binance/Bybit/Kraken), CQRS Command Bus, Circuit Breakers, Supervisor, Agendador e Grafo de Conhecimento Causal.
- [ADR-032: Autonomous Quant Research Lab & Economic Decision Layer (Fase 15)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-032-autonomous-quant-research-lab.md) — Diretor de pesquisa autônomo, cálculo de Expected Value of Information (EVI), detecção de lacunas de conhecimento e gerador de artigos científicos internos.
- [ADR-033: Unified Cognitive Architecture](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-033-unified-cognitive-architecture.md) — Auditoria arquitetural completa, análise dos 5 grandes mestres da computação, Teoria Unificada do Lyzer Edge (4 Abstrações Universais) e critérios de governança para minimalidade.
- [ADR-034: Universal Cognitive Calculus (UCC)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-034-universal-cognitive-calculus.md) — Formalização matemática do sistema cognitivo através de 4 primitivas ($\langle \mathcal{S}, \mathcal{T}, \mathcal{M}, \mathcal{O} \rangle$) e Teorema da Impossibilidade de Expressão.
- [ADR-035: Lyzer Guardian Meta-Governance & Maximum Compression Law](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-035-lyzer-guardian-metagovernance-constitution.md) — Constituição do Lyzer Guardian v2, Lei Zero, Regra do Ônus da Prova e Lei da Compressão Máxima.
- [ADR-036: Lyzer Guardian v3 Meta-Governance & Removal-First Law](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-036-lyzer-guardian-v3-metagovernance.md) — Postura de Matemático da Complexidade, Hipótese Padrão de Teste Destrutivo, Lei da Remoção Antes da Adição, 15 Perguntas de Inegibilidade e Protocolo de Resposta em 6 Etapas.
- [ADR-037: The Evidence Era & Architecture Complexity Index (ACI)](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/docs/architecture/ADR-037-evidence-era-architecture-complexity-index.md) — Triplo nível de mutabilidade, Era da Evidência, medições sob estresse e métrica ACI ($ACI_{t+1} \le ACI_t$).
- [CONSTITUTION.md: Permanent Architectural Charter](file:///c:/Users/WDAGUtilityAccount/Downloads/projeto/CONSTITUTION.md) — Carta Arquitetural Permanente do Lyzer Edge. Encerramento definitivo de ADRs filosóficas, codificação final das 4 primitivas $\langle \mathcal{S}, \mathcal{T}, \mathcal{M}, \mathcal{O} \rangle$, 9 abstrações base, 15 testes de inegibilidade, Lei da Remoção Antes da Adição e Família ACI.
