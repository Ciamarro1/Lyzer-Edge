...
| ID | Batch | Hypothesis | Primary Rejection Reason |
|----|-------|------------|--------------------------|
...
|----|-------|------------|--------|------|
| **H009** | 013 | Wyckoff Spring / Volume Rejection | PROMISING | Successfully completed Discovery Phase (Negative Control, Dose-Response, Horizon). Awaiting Phase B: Frozen Confirmation. |
